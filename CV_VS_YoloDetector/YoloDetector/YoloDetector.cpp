...
int main(int argc, char *argv[])
{
	...
	auto obj_names = objects_names_from_file("data/yolo.names");

//	Detector detector("yolo-voc.cfg", "yolo-voc.weights");
//	auto obj_names = objects_names_from_file("data/voc.names");

//	Detector detector("yolo9000.cfg", "yolo9000.weights");
//	auto obj_names = objects_names_from_file("data/9k.names");
